...
#ifndef QGSREGISTERPAGE_H
#define QGSREGISTERPAGE_H

#include <ui_qgsregisterpagebase.h>
...
class QgsRegisterPage : public QWizardPage, public Ui::QgsRegisterPageBase
{
  Q_OBJECT;
