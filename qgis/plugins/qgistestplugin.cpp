   ...
   : qgisMainWindow(qgis), qI(_qI)
{
   ...
   QMessageBox::information(qgisMainWindow,
                            "Message From Plugin", 
                            "This message is from within the test plugin");
   ...
   QAction * zoomPreviousAction = 
      new QAction( "Zoom Previous",
                   QIconSet(icon_matrix), 
                   "&Zoom Previous", 
                   CTRL+Key_S, 
                   qgisMainWindow, 
                   "zoomFull" );
   ...
   QToolBar * fileTools = 
      new QToolBar( (QMainWindow *)qgisMainWindow, "zoom operations" );
