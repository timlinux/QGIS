 ...
 * An example QGIS plugin, illustrating how to add menu items,
 * a toolbar, and perform an operation on the map canvas.
 *
...
class QgisTestPlugin : public QObject, public QgisPlugin
{
   ...
   public:
      ...
      /**  Constructor for a plugin. 
       ...
       The QgisApp and QgisIface pointers
       are passed by QGIS when it attempts to instantiate the plugin.

       @param qgis Pointer to the QgisApp object @param qI Pointer to
              the QgisIface object.
      ...
      /**
       * Virtual function to return the name of the plugin. The name
       * will be used when presenting a list of installable plugins to
       * the user
       */
